              ...
              <div
                ...
                <div className="pl-20 text-3xl font-semibold">
                  ...
                  <input type='hidden' value={1} 
                    ...
                    <label htmlFor="reservationDate" className="text-center text-lg">출발일(필수)</label>                   
                  ...
                  className="w-full ml-5 text-gray-500 bg-white border rounded-md shadow-sm outline-none appearance-none focus:border-none">
                    ...
                    {/* 드롭다운 2 */}
                  <label htmlFor="personnel" className="text-center text-lg">인원수(필수)</label>
                  ...
                  className="w-full ml-5 text-gray-500 bg-white border rounded-md shadow-sm outline-none appearance-none focus:border-none">
                    ...
                    <button type="submit" className="flex justify-center mr-40 py-4 px-10 mx-10 text-xl font-bold mt-7 rounded-2xl text-number-color bg-zinc-100">
                    예약하기
                  </button>                             
                  </form> :
                  null
           ...
           {loginUser.username?
            <div className="pb-16 border-b">
              ...
              <div className="pb-16 border-b">
                ...
                <div onClick={()=> toggle?setToggle(false):setToggle(true)}  tabIndex="1"  className="flex flex-col justify-center py-10 mx-24 mt-12 bg-white rounded-2xl drop-shadow-2xl shadow-slate-50">
                  <p  className="font-semibold flex justify-center">펼쳐보기 ▼</p>
                    <div className={`${toggle && 'hidden'}`}>
                     {post.images.filter((_,i)=>i!==0).map(item=>{                   
                      return(
                        <Image key={item} src={item}  width={640} height={1856} layout="responsive" />   
                      )                                         
                     })}
                     </div>
                  <div>
