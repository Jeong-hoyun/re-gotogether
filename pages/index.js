      ...
      <main className="py-6 px-4 sm:p-6 md:py-10 md:px-8">
        <div className="max-w-4xl mx-auto">
          ...
          {/* <div className="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
            <ul className="flex flex-wrap -mb-px">
              <li className="mr-2">
                <a
                  href="#"
                  className="inline-block p-4 rounded-t-lg border-b-2 border-transparent hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300 role"
                >
                  그룹별
                </a>
              </li>
          ...
          <div id="myTabContent">
            ...
            >
              <p className="hidden text-sm text-gray-500 dark:text-gray-400">
                This is some placeholder content the{" "}
                <strong className="font-medium text-gray-800 dark:text-white">
          ...
          <div className="flex">
            <div className="mr-5 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
              <a href="#">
                <img
              ...
              <div className="p-5">
                <p className="text-sm mb-1 font-normal text-gray-700 dark:text-gray-400">
                  Woman Only!
                </p>
                <a href="#">
                ...
                <a
                  href="#"
                  className="inline-flex items-center py-2 px-3 text-sx italic text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
                >
                  go ⇀
                </a>
              </div>
