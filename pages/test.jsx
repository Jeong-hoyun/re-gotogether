  ...
  const { steps, currentStepIndex, step, isFirstStep, isLastStep, back, next } =
    ...
    <div className="max-w-7xl mx-auto mt-20  bg-center">
      <form onSubmit={onSubmit} className="flex justify-between flex-wrap">
        ...
        <button type="submit" className="bg-blue-500  hover:bg-blue-700 text-white font-bold py-4 px-8 rounded">{isLastStep ? "완료" : "다음"}</button>
          {!isFirstStep && (
            <button type="button" onClick={back} className="bg-blue-500 m-1 hover:bg-blue-700 text-white font-bold py-4 px-8 rounded">
              뒤로
            </button>
          )}
