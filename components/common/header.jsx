      ...
      <header className="header">
        <div className="z-10 flex items-center h-20 bg-white border-b border-gray-200 ">
          <div className="relative w-full max-w-screen-xl px-6 mx-auto">
            ...
            <div id="MainDiv" className="grid grid-cols-2 gap-x-2 grid-flow-row-dense md:flex md:items-center md:mx-6">
              ...
              {/* <Search /> */}
              {/* 화면이 작아지면 다음줄로 넘어가게*/}
              <div id="seconddiv" className="col-span-3 mx-auto">
              <SearchBar/>
              </div>
                  ...
                  <div className="flex">
                    ...
                    {loginUser.username ? (
                      ...
                      <Link href="/login">
                        ...
                        <Login/>
                        <div className="text-xxs lg:text-base">로그인</div>
                        </a>
                      </Link>
                    )}
                    {loginUser.username ? (
                      ...
                      <Link href="/signup">
                        <a className="flex shrink-0 items-center mr-2 hover:text-gray-700">
                          <Signup/>
                          <div className="text-xxs lg:text-base">회원가입</div>
                        </a>
                      </Link>
                    )}
                  </div>
