...
export function Zeroform({ zero, updateFields, name }) {
  return (
    <div className="relative">
      ...
      <button
        className="absolute px-4 py-4 border-2 border-solid lg:top-96 rounded-3xl z-2 left-16 top-24 lg:left-80 lg:ml-96 lg:text-xl lg:border-amber-300 text-amber-300"
